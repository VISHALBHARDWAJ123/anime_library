...
class CharacterDetailController = CharacterDetailsController with _$CharacterDetailController;
...
abstract class CharacterDetailsController with Store {
  ...
  Future<void> getCharacterDetails({required int characterId}) async {
    loading = true;
    try {
      await _apiHelper.getCharacterFullById(characterId: characterId).then((value) => characterData = value);
